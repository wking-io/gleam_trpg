...
//
pub opaque type CanvasRenderingContext2D

// Get the 2D render context from Canvas
//
@external(javascript, "./canvas_ffi.mjs", "get_context_2d")
pub fn get_context_2d(canvas: Canvas) -> CanvasRenderingContext2D

// Get the 2D render context from Canvas
//
@external(javascript, "./canvas_ffi.mjs", "clear_rect")
pub fn clear_rect(context: CanvasRenderingContext2D) -> CanvasRenderingContext2D

@external(javascript, "./canvas_ffi.mjs", "clear_rect")
pub fn clear_rect(context: CanvasRenderingContext2D) -> CanvasRenderingContext2D

/// Draws an image at the destination (dx, dy)
@external(javascript, "./canvas_ffi.mjs", "draw_image_simple")
...
@external(javascript, "./canvas_ffi.mjs", "draw_image_scaled")
...
@external(javascript, "./canvas_ffi.mjs", "draw_image_cropped")
